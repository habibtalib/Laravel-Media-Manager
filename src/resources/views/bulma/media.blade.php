...
@section('media')
    <div id="app">
        {{-- top toolbar --}}
        <nav id="toolbar" class="field is-grouped">
            {{-- left toolbar --}}
            <div class="nav-left">
                {{-- manager --}}
            ...
            <div class="flex">
                ...
                <div id="right">
                    ...
                    <div class="count" v-if="allItemsCount">
                        <p class="title m-0" v-if="bulkItemsCount">@{{ bulkItemsCount }} Selected</p>
                        <p class="title m-0" v-if="searchItemsCount !== null && searchItemsCount >= 0">@{{ searchItemsCount }} Found</p>
                        <p class="title m-0">@{{ allItemsCount }} Total</p>
                    </div>
                </div>
            </div>
        </div>
